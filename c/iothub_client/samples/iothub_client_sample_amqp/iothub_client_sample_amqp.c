...
static const char* connectionString = "HostName=iot-sdks-test.azure-devices.net;DeviceId=TamerDevice16;SharedAccessKey=1pDTI4OZhbkEAcoK1QkU/HQaQoTFSLRvEtUjtktlLvY=";
